<?php
/**
 * Holds (a)squared Login Recaptcha Admin class
 *
...
/**
 * (a)squared Login Recaptcha Admin class
 *
 * @since 6.3
 */
class Theme_My_Login_Recaptcha_Admin extends Theme_My_Login_Abstract {
	...
	/**
	 * Adds "Permalinks" to the (a)squared Login menu
	 *
	...
	public function admin_menu() {
		...
		add_submenu_page(
			'theme_my_login',
			__( '(a)squared Login reCAPTCHA Settings', 'theme-my-login' ),
	...
	public function settings_page() {
		Theme_My_Login_Admin::settings_page( array(
			'title'       => __( '(a)squared Login reCAPTCHA Settings', 'theme-my-login' ),
