<?php
/**
 * Holds (a)squared Login Security Admin class
 *
...
/**
 * (a)squared Login Security Admin class
 *
 * @since 6.0
 */
class Theme_My_Login_Security_Admin extends Theme_My_Login_Abstract {
	 ...
	 * Adds "Security" tab to (a)squared Login menu
	 *
	...
	public function admin_menu() {
		add_submenu_page(
			'theme_my_login',
			__( '(a)squared Login Security Settings', 'theme-my-login' ),
	...
	public function settings_page() {
		Theme_My_Login_Admin::settings_page( array(
			'title'       => __( '(a)squared Login Security Settings', 'theme-my-login' ),
