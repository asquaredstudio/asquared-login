<?php
/**
 * Holds (a)squared Login User Moderation Admin class
 *
...
/**
 * (a)squared Login User Moderation Admin class
 *
 * @since 6.0
 */
class Theme_My_Login_User_Moderation_Admin extends Theme_My_Login_Abstract {
	...
	/**
	 * Adds "Moderation" to (a)squared Login menu
	 *
	...
	public function admin_menu() {
		add_submenu_page(
			'theme_my_login',
			__( '(a)squared Login User Moderation Settings', 'theme-my-login' ),
	...
	public function settings_page() {
		Theme_My_Login_Admin::settings_page( array(
			'title'       => __( '(a)squared Login User Moderation Settings', 'theme-my-login' ),
