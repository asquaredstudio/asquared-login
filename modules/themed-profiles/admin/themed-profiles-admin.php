<?php
/**
 * Holds (a)squared Login Themed Profiles Admin class
 *
...
/**
 * (a)squared Login Themed Profiles Admin class
 *
 * @since 6.2
 */
class Theme_My_Login_Themed_Profiles_Admin extends Theme_My_Login_Abstract {
	...
	/**
	 * Adds "Themed Profiles" tab to (a)squared Login menu
	 *
	...
	public function admin_menu() {
		add_submenu_page(
			'theme_my_login',
			__( '(a)squared Login Themed Profiles Settings', 'theme-my-login' ),
	...
	public function settings_page() {
		Theme_My_Login_Admin::settings_page( array(
			'title'       => __( '(a)squared Login Themed Profiles Settings', 'theme-my-login' ),
