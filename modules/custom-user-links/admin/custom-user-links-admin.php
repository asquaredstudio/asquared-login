<?php
/**
 * Holds (a)squared Login Custom User Links Admin class
 *
...
/**
 * (a)squared Login Custom User Links Admin class
 *
 * @since 6.0
 */
class Theme_My_Login_Custom_User_Links_Admin extends Theme_My_Login_Abstract {
	...
	/**
	 * Adds "User Links" to (a)squared Login menu
	 *
	 * @since 6.0
	 * @access public
	 */
	public function admin_menu() {
		...
		add_submenu_page(
			'theme_my_login',
			__( '(a)squared Login Custom User Links Settings', 'theme-my-login' ),
	...
	public function settings_page() {
		...
		?>
		<div class="wrap">
			<h2><?php esc_html_e( '(a)squared Login Custom User Links Settings', 'theme-my-login' ); ?></h2>
			<?php settings_errors(); ?>
